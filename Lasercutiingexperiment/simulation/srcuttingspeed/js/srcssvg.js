...
document.getElementById("dimsubmit").onclick=function()
{
    ...
    if(shape==0)
    {
        ...
        setTimeout(function()
        {
            ...
            document.getElementById("laserpart1").style.strokeWidth =1.4;
            ...
            setTimeout(function()
            {
                ...
                console.log("laserhorizontalfront2 strokedasharray is ",document.getElementById("laserhorizontalfront2").style.strokeDasharray);
                ...
                setTimeout(function()
                {
                    ...
                    console.log("laservertical3 strokedasharray is ",document.getElementById("laservertical3").style.strokeDasharray);
                    ...
                    setTimeout(function()
                    {
                        ...
                        },(breadth/cutspeed)*1000);
                    },(length/cutspeed)*1000);
                },(breadth/cutspeed)*1000);
            },(length/cutspeed)*1000);
    ...
    else if(shape==1)
    {
        ...
        setTimeout(function()
        {
            ...
            document.getElementById("laserfront1").setAttribute('d',"m168.1 303.5h"+(leftcorner-168)+"");
            document.getElementById("laserfront1").style.strokeWidth =1.4;
            document.getElementById("laserfront1").setAttribute("class","draw"); 
            document.getElementById('laserfront1').style.visibility="visible";
